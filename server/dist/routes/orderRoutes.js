...
import { placeOrder, getOrders, getMyOrders, getOrderById, updateOrderStatus, deleteOrder, } from "../controllers/orderController.js";
...
// ===================================
router.put("/:id", protect, authorize("admin", "superAdmin"), validateParams(validateOrderIdParam), validateBody(validateOrderStatusBody), updateOrderStatus);
// ===================================
// ADMIN DELETE ORDER
// ===================================
router.delete("/:id", protect, authorize("admin", "superAdmin"), validateParams(validateOrderIdParam), deleteOrder);
