...
export function validatePlaceOrderBody(body: any): string | null {
...
export function validateOrderStatusBody(body: any): string | null {
  if (!body || typeof body !== "object") {
    return "Request body is required.";
  }
...
export function validateOrderIdParam(params: any): string | null {
